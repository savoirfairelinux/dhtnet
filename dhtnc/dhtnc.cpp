...
DhtNc::DhtNc(dht::crypto::Identity identity, const std::string& bootstrap_ip_add, const std::string& bootstrap_port)
...
DhtNc::DhtNc(dht::crypto::Identity identity, const std::string& bootstrap_ip_add, const std::string& bootstrap_port, dht::InfoHash peer_id, int port, const std::string& ip_add) : DhtNc(identity, bootstrap_ip_add, bootstrap_port)
{
...
{
    std::string idDir = std::string(getenv("HOME")) + "/.dhtnc";
