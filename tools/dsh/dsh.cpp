    ...
    iceFactory(std::make_shared<IceTransportFactory>(logger))
{
    ...
    connectionManager->onICERequest([this, certStore,identity,anonymous](const DeviceId& deviceId ) { // handle ICE request
        return isSameCertificateAuthority(certStore, deviceId, identity, anonymous, logger);
    });
