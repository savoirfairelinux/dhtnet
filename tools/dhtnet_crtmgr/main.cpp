    ...
    if (params.interactive) {
        ...
        if (usage == "client") {
            do {
                ...
                use_server_ca = std::tolower(use_server_ca);
        ...
        std::print("Enter the path to save identities and config [{}]: ", home_dir);
        ...
        if (usage == "client") {
            ...
            do {
                std::print("Configure SSH to support dnc protocol? [Y/n] (default: yes): ");
                std::getline(std::cin, ssh_setup);
                ssh_setup = std::tolower(ssh_setup);
            ...
            if (std::filesystem::exists(yaml_config)) {
                do {
                    ...
                    overwrite = std::tolower(overwrite);
