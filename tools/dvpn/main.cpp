...
main(int argc, char** argv)
{
    ...
    if (params.help ){
          fmt::print("Usage: dvpn [options] [PEER_ID]\n"
               ...
               "  -d, --tun_interface      Specify the tun_interface option with an argument.\n"
    ...
    if (params.listen) {
        ...
        dvpn = std::make_unique<dhtnet::Dvpn>(params.path, identity, params.bootstrap, params.turn_host, params.turn_user, params.turn_pass, params.turn_realm, params.tun_ip, params.tun_netmask);
    } else {
