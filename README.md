...
**Note**: 
When using any of the tools mentioned above, ensure that the client and server on the same machine use different certificates for authentication. Specify distinct identity file paths for the client and server to guarantee they utilize separate certificates.
