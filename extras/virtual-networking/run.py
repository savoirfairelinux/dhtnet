...
from lib.core.paths import DEFAULT_ARTIFACT_ROOT, PROBE_DIR, SCENARIO_DIR
    ...
    *,
    ...
    for index, scenario in enumerate(scenarios, start=1):
        ...
        scenario_exit_code = run_scenario(
            ...
            service_stop_timeout_s=service_stop_timeout_s,
        )
        print('\n\n')
...
def main() -> int:
    ...
    for scenario in scenarios.values():
        validate_scenario_against_fixtures(scenario, load_topology(scenario.topology), probes)
