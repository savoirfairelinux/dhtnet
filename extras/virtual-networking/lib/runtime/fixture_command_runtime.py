...
from .fixture_command_teardown import stop_fixture
...
def setup_fixture(
    ...
    *,
    ...
    try:
        ...
        resolved_artifacts = resolve_value(raw_artifacts, artifact_context, scenario_name=scenario.name)
        if not isinstance(resolved_artifacts, dict) or not all(
        ...
        artifacts.update(resolved_artifacts)
