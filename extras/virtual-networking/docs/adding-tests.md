...
| A new fixture kind, actor kind, or probe action type | Python/runtime changes in `lib/runtime/`, `lib/loaders/`, or `lib/tools/probe_actions/` plus the new JSON definition(s) |
