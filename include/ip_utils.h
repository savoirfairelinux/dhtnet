...
public:
     ...
     * host, ie. it is neither unspecified, loopback nor link-local. Private
     * addresses do qualify: they are reachable from the same network, which
     * is what local peer discovery relies on.
     */
