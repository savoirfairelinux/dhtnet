...
public:
    ...
    // TODO: The current implementation doesn't seem to do the
    // "make it available for future use" part... fix this.
...
private:
    ...
    // TODO: make sure this is reset when needed (e.g. when stopping UPnP)
